<?php  //[STAMP] d89cea42e08fb271e5f83bd5aebcf824
...
trait AcceptanceTesterActions
{
     ...
     * @see \Codeception\Module\WebDriver::type()
     */
    public function tryToType($text, $delay = 0) {
     ...
     * @see \Codeception\Module\WebDriver::type()
     */
    public function retryType($text, $delay = 0) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Module\WebDriver::seeNumberOfTabs()
     */
    public function tryToSeeNumberOfTabs($number) {
     ...
     * @see \Codeception\Module\WebDriver::seeNumberOfTabs()
     */
    public function retrySeeNumberOfTabs($number) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
